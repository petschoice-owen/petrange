            ...
            <div class="inner p-60">
                <div class="flex-mob col-5">
                    <div class="footer-logo">
                        <img src="/wp-content/themes/custom/base_html/www/images/logo-black.svg" alt="">
                    </div>
                    <div class="menu-1">
    ...
    <?php if ( is_page( 'cart' ) || is_cart() ) { ?>
        <script>
            ...
            $(document).ready(function() {
                ...
                var shippingMessage = $('.woocommerce-shipping-methods').text().trim();
                if ( shippingMessage.includes("Enter your address") ) {
                    $('.cart_totals .wc-proceed-to-checkout, .cart_totals .have-coupon').addClass('show');
                }
                else if ( shippingMessage.includes("Standard:") ) {
                    $('.cart_totals .wc-proceed-to-checkout, .cart_totals .have-coupon').addClass('show');
                }
                else if ( shippingMessage.includes("Free shipping") ) {
                    $('.cart_totals .wc-proceed-to-checkout, .cart_totals .have-coupon').addClass('show');
                }
                else {
                    $('.cart_totals .wc-proceed-to-checkout, .cart_totals .have-coupon').removeClass('show');
            ...
            $('body').on('updated_cart_totals', function() {
                ...
                if ( total < minAmount ) {
                    ...
                    setTimeout(() => {
                        $('<ul class="woocommerce-error" role="alert"><li>Your current order total is '+totalAmount+' — you must have an order with a minimum of £15.00 to place your order.</li></ul>').insertAfter('.woocommerce > .woocommerce-notices-wrapper');
                    }, 100);
                }
                    ...
                    $('<ul class="woocommerce-error" role="alert"><li>Your order value is '+totalAmount+'. We do not currently accept online order values of over £250.00.</li></ul>').insertAfter('.woocommerce > .woocommerce-notices-wrapper');
                }
                else {
                    $('.woocommerce-error').each(function() {
                        if ( $(this).text().trim().includes("minimum") || $(this).text().trim().includes("over") ) {
